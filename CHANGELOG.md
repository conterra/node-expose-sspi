...
* added bug info in package.json ([30f2d03](https://github.com/jlguenego/node-expose-sspi/commit/30f2d03daa89d87d608c12d6f8309eab2e84c286))
* added spn list from status command ([ec2e1cf](https://github.com/jlguenego/node-expose-sspi/commit/ec2e1cfcf32e05106017e39533f44301913b9e86))


### Bug Fixes

* all test ok ([0d5dd4f](https://github.com/jlguenego/node-expose-sspi/commit/0d5dd4f48247ca38101211986deff6eb276be84d))
* test ok ([a4fcd93](https://github.com/jlguenego/node-expose-sspi/commit/a4fcd93b9cb720fc4a4c3df6979406bd6a0cc27a))

### [0.1.54](https://github.com/jlguenego/node-expose-sspi/compare/v0.1.53...v0.1.54) (2020-11-28)


### Bug Fixes

* quote in url bug [#58](https://github.com/jlguenego/node-expose-sspi/issues/58) ([5fad3bf](https://github.com/jlguenego/node-expose-sspi/commit/5fad3bf970c8a416885c03bad0e609ebb7b87548))
...
* added req.sso = req.session.sso ([191c448](https://github.com/jlguenego/node-expose-sspi/commit/191c4486f2a547bf739ee602df319addb33be5bf))
* better typing - remove any ([39590d6](https://github.com/jlguenego/node-expose-sspi/commit/39590d6adc4541ce7af145340b8b82ffb33f5a8f))
...
* updated dependancies ([7954ebb](https://github.com/jlguenego/node-expose-sspi/commit/7954ebb2c841d4a06a31275504e18a53b8ac8a93))
...
* SPN better identification ([bc8e856](https://github.com/jlguenego/node-expose-sspi/commit/bc8e856ee1e3a86d5ad9aeac4b45d0554b11fe1b))
